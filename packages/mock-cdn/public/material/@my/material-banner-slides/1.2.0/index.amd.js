define('@my/material-banner-slides', ['vue'], function (vue) {
  'use strict';
    ...
    setup(__props) {
      ...
      const autoPlayFn = () => {
        ...
        timer = window.setInterval(() => {
          ...
          index.value++;
          if (
            Array.isArray(props == null ? void 0 : props.banners) &&
            index.value >=
              ((_a = props == null ? void 0 : props.banners) == null
                ? void 0
                : _a.length)
          ) {
            index.value = 0;
      ...
      const goToNextSlide = (step) => {
        ...
        if (
          ...
          index.value =
            ((_b = props == null ? void 0 : props.banners) == null
              ? void 0
              : _b.length) - 1;
        }
      };
