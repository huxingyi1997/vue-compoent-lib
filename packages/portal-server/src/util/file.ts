...
export function getDemoHTML(demoName: string): string | null {
  ...
  const runtimMap: Record<string, string> = {
    ...
    {
      "imports": {
        "vue": "/public/cdn/pkg/vue/3.3.4/dist/vue.runtime.esm-browser.js",
        "vue-router": "/public/cdn/pkg/vue/3.3.4/dist/vue.runtime.esm-browser.js"
      }
    }
  </script>`,
    amd: `
    <script src="/public/cdn/pkg/requirejs/2.3.6/require.js"></script>
    <script src="/public/cdn/pkg/vue/3.3.4/dist/vue.runtime.global.js"></script>
    <script> define("vue", [], function() { return window.Vue; }) </script>
    `,
    iife: '<script src="/public/cdn/pkg/vue/3.3.4/dist/vue.runtime.global.js"></script>'
  };
